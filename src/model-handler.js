...
/*CONTACTS HOVER*/
var elementsWithSmth=document.querySelectorAll('[data-custom="social"]'),tr=document.getElementById("contactsTextDisplayer-ranking"),tt=document.getElementById("contactsTextDisplayer-tutorial"),tm=document.getElementById("contactsTextDisplayer-email"),ts=document.getElementById("contactsTextDisplayer-school"),ti=document.getElementById("contactsTextDisplayer-instagram"),tp=document.getElementById("contactsTextDisplayer-podcast");elementsWithSmth.forEach(function(e){var t=e.className;e.addEventListener("mouseover",function(){switch(t){case"rankingContainer":tr.classList.add("moveInTextDisplay");break;case"tutorialContainer":tt.classList.add("moveInTextDisplay");break;case"mailContainer":tm.classList.add("moveInTextDisplay");break;case"schoolContainer":ts.classList.add("moveInTextDisplay");break;case"instagramContainer":ti.classList.add("moveInTextDisplay");break;case"podcastContainer":tp.classList.add("moveInTextDisplay");break;default:console.log("")}}),e.addEventListener("mouseout",function(){switch(t){case"rankingContainer":tr.classList.remove("moveInTextDisplay");break;case"tutorialContainer":tt.classList.remove("moveInTextDisplay");break;case"mailContainer":tm.classList.remove("moveInTextDisplay");break;case"schoolContainer":ts.classList.remove("moveInTextDisplay");break;case"instagramContainer":ti.classList.remove("moveInTextDisplay");break;case"podcastContainer":tp.classList.remove("moveInTextDisplay");break;default:console.log("")}})});